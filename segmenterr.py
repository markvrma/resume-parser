...
# searches through the input string to find the indices where each section begins. populates the resume_segments dictionary with the indices of each section.
    def find_segment_indices(self, string_to_search, resume_segments, resume_indices):
        for i, line in enumerate(string_to_search):
            ...
            if [w for w in self.work_and_employment if header.startswith(w)]:
                try:
...
# slices the sections of the resume based on the indices found in find_segment_indices                   
...
# refines segmentation based on zero shot classifier
